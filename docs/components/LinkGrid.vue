...
<template>
	...
	<div class="flex flex-wrap gap-4">
		<a v-for="item of items" :key="item.name" :href="item.link" :target="item.target" class="Link w-30 h-30 text-center text-inherit flex flex-col items-center justify-center">
