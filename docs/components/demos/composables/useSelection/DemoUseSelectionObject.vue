...
<template>
	<div class="flex flex-wrap gap-6 mb-4">
		<div v-for="option in options" :key="option.value.title" class="flex flex-col gap-1 items-center cursor-pointer" :class="option.isSelected && 'text-primary'" @click="select(option.value)">
			<i :class="option.value.icon" class="text-lg" />
